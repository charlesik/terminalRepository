function BottomBar() {
    return (
        <div className="flex justify-between text-[#607B96] border-t w-full h-[30px]  border-[#1E2D3D] absolute bottom-0">
            <div className="flex ">
                <div className="pt-1 text-[#607B96] border-r-[1px] w-[250px] border-[#607B96]">find me in</div>
                <div className="pt-1 text-[#607B96] border-r-[1px] border-[#607B96] w-[100px] text-center">LinkedIn</div>
