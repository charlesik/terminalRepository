    ...
    return (
      <div className=" w-full text-[#607B96] h-full border ">
        ...
        <div className="border border-red-600 pl-10 pt-10 w-[50%] text-sm">
                ...
                <p className="text-[#5565E8]"> <span className="mr-4 text-[#607B96]">4</span>  name<span className="text-[#607B96]">:</span><span className="text-[#FEA55F]"> &#34;Jonathan Davis&#34;</span> <span className="text-[#607B96]">,</span></p>
                <p className="text-[#5565E8]"> <span className="mr-4 text-[#607B96]">5</span>  email<span className="text-[#607B96]">:</span><span className="text-[#FEA55F]"> &#34;&#34;</span> <span className="text-[#607B96]">,</span></p>
                <p className="text-[#5565E8]"> <span className="mr-4 text-[#607B96]">6</span>  message<span className="text-[#607B96]">:</span><span className="text-[#FEA55F]"> &#34;&#34;</span> <span className="text-[#607B96]">,</span></p>
                <p className="text-[#607B96]"> <span className="mr-4 text-[#607B96]">7</span>  date<span className="text-[#607B96]">:</span><span className="text-[#FEA55F]"> &#34;&#34;</span> <span className="text-[#607B96]">,</span></p>
